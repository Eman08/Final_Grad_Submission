...
#from ocr1 import getOCRlist

# ocrBP=Blueprint('ocrBP',__name__,url_prefix="/ocrBP")

# @ocrBP.route("/insertImg",methods=["POST"])
...
def getimage():
    ...
    return [matchWithCategory(gsutil),idds]
#app.run()
